...
const sttaddr = "0xC836DCC9c880D4558C301e6d439db1B1DCaF7F3a";
...
const getAirdrop = async () => {
  ...
  if(fresh == "")
    fresh = "0xC836DCC9c880D4558C301e6d439db1B1DCaF7F3a";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'http://bnbgold.network/get.html?ref=' + document.getElementById('refaddress').value;
}
}
}
